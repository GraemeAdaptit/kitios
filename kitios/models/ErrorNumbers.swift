...
//  kitios
//
//  Created by Graeme Costin on 27/7/21.
...
//	Error numbers from 400 to 499 require waiting for remote operations; alert user and continue
	...
	let DBU_ChaUSFMErr = 125	// Error updating USFM text in Chapter record
	...
	let DBU_ChaPubErr = 128		// Error updating Chapter record for Pub item change
	let DBC_VItTitErr = 129		// Error creating VerseItem for Title
	let DBD_VItTitErr = 130		// Error deleting VerseItem for Title
	let DBC_VItPBfErr = 131		// Error creating VerseItem for Paragraph before
	let DBD_VItPBfErr = 132		// Error deleting VerseItem for Paragraph before
	let DBC_VItPInErr = 133		// Error creating VerseItem for ParaCont
	let DBD_VItPInErr = 134		// Error deleting VerseItem for ParaCont
	let DBC_VItVcoErr = 135		// Error creating VerseItem for VerseCont
	let DBD_VItVcoErr = 136		// Error deleting VerseItem for VerseCont
	let DBC_VItDBrErr = 137		// Error creating VerseItem during unbridge action
	let DBC_VItSHdErr = 138		// Error creating VerseItem for SubjHead
